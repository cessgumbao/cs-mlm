...
<div class="row">
    <div class="col l12">
        <div class="card-panel">
            <h6 class="header m-0">Purchases <a class="waves-effect waves-light btn right">Details</a></h6>
...
<div class="row">
    <div class="col s12 m12 l12">
        <div class="card-panel">
            <h6 class="header m-0">Group Team Purchases <a class="waves-effect waves-light btn right">See All</a></h6>
            <div class="row">
                <div class="col s12 m12 l12">
                    <table class="table table-sm" 
                        id="pgs_table"
