    ...
    <div class="col s12 m4 l4">
        <div class="card gradient-shadow min-height-100">
            <div class="padding-4">
                <div class="row">
                    <div class="col s7 m7">
                        <i class="fa-2x material-icons background-round mt-5 gradient-90deg-light-blue-cyan white-text">timeline</i>
                        <p>Monthly Sales</p>
                    </div>
    ...
    <div class="col s12 m4 l4">
        <div class="card gradient-shadow min-height-100">
            <div class="padding-4">
                <div class="row">
                    <div class="col s7 m7">
                        <i class="fa-2x material-icons background-round mt-5 gradient-90deg-red-pink white-text">person_outline</i>
                        <p>Members</p>
                    </div>
                    <div class="col s5 m5 right-align">
    ...
    <div class="col s12 m4 l4">
        <div class="card gradient-shadow min-height-100">
            <div class="padding-4">
                <div class="row">
                    <div class="col s7 m7">
                        <i class="fa fa-hand-holding-usd fa-2x background-round mt-5 gradient-90deg-green-teal white-text"></i>
                        <p>Payouts</p>
                    </div>
                    <div class="col s5 m5 right-align">
...
@if (Auth::user()->hasRole(['member', 'city_distributor', 'regional_distributor']))
<!-- For Members Only -->
<div class="row">
    <div class="col s12 m12 l12">
        <div class="card-panel">
